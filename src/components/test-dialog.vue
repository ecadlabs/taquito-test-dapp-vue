<template>
  <Dialog
    :open="diagramStore.showDialog"
    @update:open="diagramStore.closeDialog"
  >
    <DialogContent>
      <DialogHeader>
      ...
      <div class="text-sm">
        ...
        <div
          v-if="typeof diagramStore.dialogContent?.content === 'string'"
          v-html="diagramStore.dialogContent.content"
        />

        <!-- Render component content -->
        <component
          v-else-if="typeof diagramStore.dialogContent?.content === 'function'"
